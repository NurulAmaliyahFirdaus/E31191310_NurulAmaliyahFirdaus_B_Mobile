package com.nurulamaliyahfirdaus.api_volley;
...
import com.nurulamaliyahfirdaus.api_volley.Adapter.AdapterData;
import com.nurulamaliyahfirdaus.api_volley.Model.ModelData;
import com.nurulamaliyahfirdaus.api_volley.Util.AppController;
import com.nurulamaliyahfirdaus.api_volley.Util.ServerAPI;
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        for(int i = 0 ; i < response.length(); i++)
                        {
                            try {
                                ...
                                md.setGrup(data.getString("grub"));
